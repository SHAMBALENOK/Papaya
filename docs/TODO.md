...
- [ ] Разделить schemas на `Create / Update / Response / List`.
- [ ] Убрать из клиентских схем поля, которые должен задавать сервер.
- [ ] Нормализовать HTTP-коды ошибок.
- [ ] Проверить права `USER / EDITOR / ADMIN`.
- [ ] Проверить JWT/cookie-аутентификацию.
- [ ] Проверить обработку некорректных данных.

## Database
- [ ] Привести в порядок Alembic.
- [ ] Все изменения БД проводить через миграции.
...
## Tests
- [ ] Настроить `pytest`.
- [ ] Настроить `pytest-asyncio`.
- [ ] Использовать `httpx` для API-тестов.
- [ ] Тест регистрации.
- [ ] Тест авторизации.
- [ ] Тест logout.
- [ ] Тест получения олимпиады.
- [ ] Тест создания.
- [ ] Тест изменения.
- [ ] Тест удаления.
- [ ] Тест проверки ролей.
